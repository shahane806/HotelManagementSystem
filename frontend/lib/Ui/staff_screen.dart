...
import 'package:frontend/bloc/StaffBloc/bloc.dart';
import 'package:frontend/bloc/StaffBloc/event.dart';
import 'package:frontend/bloc/StaffBloc/state.dart';
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      if (isEditMode) {
        ...
        context.read<StaffBloc>().add(UpdateStaff(user));
      } else {
        // Dispatch AddCustomer event
        context.read<StaffBloc>().add(AddStaff(user));
      }
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  /// ⭐ Add this to limit to 10 digits
                                  inputFormatters: [
                                      ...
                                      return Center(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Register a staff to see them here',
                                              style: TextStyle(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return Container(
                                          ...
                                          child: ListTile(
                                            ...
                                            subtitle: Text(
                                              'Email: ${staffMember.email}\nMobile: ${staffMember.mobile}\nAadhaar: ${staffMember.aadhaarNumber}\nRole${staffMember.role}',
                                              style: TextStyle(
