          ...
          child: ChoiceChip(
            label: Text(
              ...
              style: TextStyle(
                ...
                fontWeight: FontWeight.w600,
                color: state.selectedStatusFilter == status
                    ? Colors.white
                    : Colors.grey[800],
              ),
            ),
...
Widget buildGridLayout(BuildContext context, List<Map<String, dynamic>> orders,
    double screenWidth) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...items.map((item) {
                        ...
                        final customization =
                            item['customization'] as String? ?? 'None';
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext dialogContext) {
                          return AlertDialog(
                            ...
                            content: const Text(
                                'Are you sure you want to set this order as Served?'),
                            actions: [
                              TextButton(
                                onPressed: () {
